...
class Program
{
    ...
    // TODO: Crie um método/função para calcular a pegada de carbono com base nos parâmetros fornecidos:
        static double CalcularPegadaDeCarbono(double KmByDay, int hrsElectronics, int meatLunch)
        {
          double transporte = KmByDay * 365 * 0.2;
          double eletronics = hrsElectronics * 0.1;
          double consumoCarne = meatLunch * 0.5;
          
          return transporte + eletronics + consumoCarne;
        }
